...
# -*- encoding: utf-8 -*-
# stub: scholarmarkdown 3.3.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<latex-decode>.freeze, [">= 0".freeze])
  s.add_runtime_dependency(%q<citeproc-ruby>.freeze, [">= 1.1.6".freeze])
  s.add_runtime_dependency(%q<csl-styles>.freeze, [">= 0".freeze])
  s.add_runtime_dependency(%q<bibmarkdown>.freeze, ["~> 2.0.0".freeze])
  s.add_runtime_dependency(%q<katex>.freeze, [">= 0".freeze])
  s.add_runtime_dependency(%q<sskatex>.freeze, [">= 0".freeze])
  s.add_runtime_dependency(%q<kramdown-math-sskatex>.freeze, [">= 0".freeze])
  s.add_runtime_dependency(%q<execjs>.freeze, [">= 0".freeze])
  s.add_runtime_dependency(%q<mini_racer>.freeze, [">= 0".freeze])
  s.add_runtime_dependency(%q<libv8-node>.freeze, ["= 16.10.0.0".freeze])
  s.add_development_dependency(%q<bundler>.freeze, ["~> 2.0".freeze])
  s.add_development_dependency(%q<juwelier>.freeze, ["~> 2.4.7".freeze])
end
